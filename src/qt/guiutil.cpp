...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "DRACHMacoin.lnk";
}
...
{
    return GetAutostartDir() / "drachmacoin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("DRACHMacoin-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  drachmacoin-qt [" + tr("command-line options") + "]                     " + "\n";
