...
// Copyright (c) 2014 The DRACHMacoin developers
...
const string strMessageMagic = "DRACHMacoin Signed Message:\n";
...
static const int64 nStartSubsidyNEW = 149 * COIN;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DRACHMacoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DRACHMacoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("DRACHMacoin miner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    ...
    if (pindexBest->nHeight < DIFF_SWITCH_BLOCK) 
        {
            ...
            {
                printf("DRACHMacoin miner terminated\n");
                throw;
            }
