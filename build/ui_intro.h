...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to DRACHMacoin-Qt.", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where DRACHMacoin-Qt will store its data.", 0, QApplication::UnicodeUTF8));
        sizeWarningLabel->setText(QApplication::translate("Intro", "DRACHMacoin-Qt will download and store a copy of the DRACHMacoin block chain. At least %1GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", 0, QApplication::UnicodeUTF8));
